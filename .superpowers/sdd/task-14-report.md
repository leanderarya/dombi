...
HISTORICAL PASS (2026-08-24, pre-MySQL credential failure): matrix 22/22, 50 assertions; not current evidence. CURRENT SAME ROW: latest scoped run MySQL-blocked before assertions. Task 14 is NO-GO.
