...
Current verification is MySQL-blocked; no current scoped-test, migration, or dry-run PASS is claimed. Production cutover remains NO-GO until runtime evidence and full-suite blockers clear.
