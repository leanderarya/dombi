...
- Backfill owns exception-table creation and tags every synthesized attempt, obligation, and exception with `2026_08_23_000004_refund_obligations`; scoped `down()` removes exact-key rows only.
...
## Verification
- `php artisan test tests/Feature/RefundObligationTest.php` — PASS (13 tests, 30 assertions; 5.299s)
