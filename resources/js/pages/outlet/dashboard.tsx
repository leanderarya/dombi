...
export default function OutletDashboard({
    ...
    const todayOrders =
        ...
        stats.readyForCustomerPickup;
    const urgentTasks = deliveryStats.failed;
    const warningTasks =
        stats.pendingOrders +
        deliveryStats.needsDispatch +
    ...
    const hasActivity =
        todayOrders > 0 ||
        pendingTasks > 0 ||
        deliveryStats.completedToday > 0 ||
                ...
                <OutletPageShell>
                    ...
                    <div className="rounded-xl border border-border bg-white p-4">
                        <div className="grid grid-cols-4 gap-2">
                            ...
                            <StatCell
                                label="Siap"
                                value={stats.readyForCustomerPickup}
                            />
                            <StatCell
                                label="Selesai"
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            ...
                            <StatCell
                                label="Kurir"
                                value={deliveryStats.waitingPickup}
                            />
                            <StatCell
                                label="Gagal"
