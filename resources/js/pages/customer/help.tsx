                ...
                <section className="mt-6">
                    ...
                    <div className="mt-2 space-y-2">
                        <FaqItem
                            ...
                            answer="Pilih produk, tambahkan ke keranjang, pilih alamat pengiriman, lalu tap 'Pesan Sekarang'."
                        />
                        <FaqItem
                            title="Berapa lama pengiriman?"
                            answer="Pengiriman biasanya memakan waktu 30–60 menit tergantung jarak outlet ke alamat kamu."
                        />
                        <FaqItem
                            title="Bagaimana jika pesanan gagal?"
                            answer="Jika pengiriman gagal, tim kami akan menghubungi kamu untuk penjadwalan ulang atau pembatalan."
                        />
                        <FaqItem
                            title="Apakah bisa order ulang?"
                            answer="Ya, kamu bisa tap 'Order Ulang' di halaman home untuk memesan produk yang sama seperti sebelumnya."
                        />
                    </div>
                </section>
