        ...
        <CustomerMobileLayout hideTopBar>
            ...
            <header className="sticky top-0 z-30 -mx-4 -mt-5 mb-5 border-b border-zinc-100 bg-white px-4 py-3">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-base font-semibold text-slate-900">Bantuan</h1>
                </div>
            </header>

            {/* Support Contact */}
            <section>
                <h2 className="text-[11px] font-bold uppercase tracking-wider text-slate-400">Hubungi Kami</h2>
                <div className="mt-2 rounded-xl border border-zinc-100 bg-white p-4">
                    ...
                    <div className="mt-4 space-y-2">
                        <a href="https://wa.me/6281111111111" className="flex min-h-11 items-center justify-center gap-2 rounded-lg bg-emerald-700 text-sm font-semibold text-white active:bg-emerald-800">
                        ...
                        <a href="mailto:support@dombi.app" className="flex min-h-11 items-center justify-center gap-2 rounded-lg border border-zinc-200 text-sm font-semibold text-slate-700 active:bg-zinc-50">
            ...
            {/* Operational Hours */}
            <section className="mt-6">
                <h2 className="text-[11px] font-bold uppercase tracking-wider text-slate-400">Jam Operasional</h2>
                <div className="mt-2 rounded-xl border border-zinc-100 bg-white p-4">
                    <div className="space-y-2 text-sm">
                        <div className="flex justify-between"><span className="text-slate-600">Senin – Sabtu</span><span className="font-medium text-slate-900">07:00 – 20:00</span></div>
                        <div className="flex justify-between"><span className="text-slate-600">Minggu</span><span className="font-medium text-slate-900">08:00 – 17:00</span></div>
                    </div>
                    <p className="mt-3 text-xs text-slate-400">Pesanan di luar jam operasional akan diproses keesokan hari.</p>
                </div>
            </section>
...
function FaqItem({ title, answer }: { title: string; answer: string }) {
    return (
        <div className="rounded-xl border border-zinc-100 bg-white p-4">
            ...
            <div className="mt-1.5 text-xs leading-relaxed text-slate-500">{answer}</div>
        </div>
    );
}
