        ...
        <div className="min-h-dvh bg-background text-text">
            ...
            <main className="mx-auto max-w-lg px-4 pt-4 pb-24">
                ...
                <section className="mt-6">
                    ...
                    <div className="mt-2 space-y-2">
                        ...
                        <ValueCard
                            ...
                            title="Kecepatan"
                            description="Pengiriman cepat melalui jaringan outlet dan kurir terdekat."
                        />
                        <ValueCard
                            icon={
                            ...
                            title="Kepercayaan"
                            description="Transparansi penuh dari pemesanan hingga pengiriman."
                        />
                    </div>
                </section>
                ...
                <p className="mt-6 text-center text-[11px] text-text-subtle">
                    © 2026 Dombi. Hak cipta dilindungi.
                </p>
            </main>
        </div>
    );
