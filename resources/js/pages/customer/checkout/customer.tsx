                                ...
                                <div className="flex items-start justify-between gap-3">
                                    <div className="min-w-0 flex-1">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-[11px] font-bold uppercase tracking-wider text-text-subtle">Lokasi Pengiriman</span>
                                        </div>
                                    ...
                                    <button
                                        ...
                                        className="min-h-[44px] shrink-0 rounded-lg border border-slate-200 px-3 text-xs font-semibold text-text active:opacity-80"
                                    >
                                        Ubah Lokasi
                                    </button>
                                </div>
                    ...
                    {!hasKnownLocation && (
                        <SectionCard label="Alamat">
                            <textarea
                                ...
                                className="min-h-20 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-text placeholder:text-text-subtle focus:border-emerald-300 focus:ring-1 focus:ring-emerald-200"
                            ...
                            <div className="mt-3 grid grid-cols-1 gap-3">
                                ...
                                <label className="block">
                                    ...
                                    <textarea
                                        ...
                                        className="mt-1 min-h-16 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-text placeholder:text-text-subtle focus:border-emerald-300 focus:ring-1 focus:ring-emerald-200"
    ...
    return (
        <header className="-mx-4 -mt-5 border-b border-slate-200 bg-white px-4 py-3">
            <div className="mx-auto flex max-w-lg items-center justify-between">
                <button onClick={() => router.visit(backHref)} className="flex h-11 w-11 items-center justify-center rounded-lg text-text active:opacity-80">
    ...
    return (
        <label className="block">
            ...
            <input
                ...
                inputMode={inputMode}
                className="mt-1 min-h-11 w-full rounded-lg border border-slate-200 bg-white px-3 text-sm text-text placeholder:text-text-subtle focus:border-emerald-300 focus:ring-1 focus:ring-emerald-200"
