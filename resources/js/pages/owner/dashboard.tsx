        ...
        <>
            ...
            >
                    ...
                    <div className="space-y-2">
                        ...
                        {totalPendingActions === 0 && (
                            <div className="flex flex-col items-center justify-center py-8">
                                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-surface-muted text-emerald-600">
                ...
                {hero.outstandingAmount > 0 && (
                    <div className="mt-4 relative overflow-hidden rounded-xl bg-gradient-to-br from-primary to-primary-hover px-6 py-5 text-white">
