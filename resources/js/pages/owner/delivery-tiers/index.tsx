...
export default function DeliveryTiersIndex({
    tiers,
}: {
    tiers: DeliveryTier[];
}) {
    ...
    return (
        ...
        >
            ...
            <div
                className="mt-4 rounded-xl bg-surface p-4 shadow-card"
                aria-label="Cara kerja tier"
            >
                ...
                <ul className="mt-2 space-y-1.5 text-xs text-text-muted">
                    <li>
                        Tier diurutkan berdasarkan jarak (sort_order). Sistem
                        mencocokkan dari tier pertama.
                    </li>
                    <li>
                        Jika jarak pelanggan melebihi tier terakhir, pesanan
                        dianggap di luar jangkauan.
                    </li>
                    <li>
                        Nonaktifkan tier untuk menonaktifkan sementara tanpa
                        menghapus.
                    </li>
                </ul>
            </div>
            ...
            <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Atur tarif pengiriman berdasarkan jarak.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    addForm.setData('min_km', e.target.value)
                                }
                                placeholder="0"
                            />
                        </div>
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    addForm.setData('max_km', e.target.value)
                                }
                                placeholder="5"
                            />
                        </div>
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    addForm.setData('fee', e.target.value)
                                }
                                placeholder="10000"
                            />
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    editForm.setData('min_km', e.target.value)
                                }
                            />
                        </div>
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    editForm.setData('max_km', e.target.value)
                                }
                            />
                        </div>
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    editForm.setData('fee', e.target.value)
                                }
                            />
                        </div>
                        <div>
            ...
            >
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Yakin ingin menghapus tier ongkir ini? Tindakan ini
