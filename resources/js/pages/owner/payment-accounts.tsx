                ...
                <div className="space-y-2">
                    {accounts.length === 0 ? (
                        ...
                        accounts.map((account) => (
                            <div key={account.id} className="rounded-xl border border-border bg-white p-4">
                                ...
                                <div className="mt-3 flex gap-2">
                                    <button
                                        ...
                                        className="rounded-lg bg-surface-muted px-3 py-1.5 text-xs font-medium text-text hover:bg-surface-muted/80"
                                    >
                                        Edit
                                    </button>
                                    <button
