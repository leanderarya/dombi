...
export default function OutletFormSheet({
    mode,
    form,
    submit,
    outlet,
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-5">
                    ...
                    <div className="space-y-4 lg:col-span-3">
                        ...
                        <Section
                            ...
                            subtitle="Identitas singkat untuk operasional cabang."
                        >
                            <Field
                                label="Nama Outlet"
                        ...
                        <Section
                            ...
                            subtitle="Data wilayah terdeteksi otomatis dari peta. Geser marker untuk memperbarui."
                        >
                            {hasLocation ? (
                                <>
                        ...
                        >
                            <TextArea
                                ...
                                placeholder="Ruko nomor 12 sebelah Indomaret..."
                            />
                        </Section>
                            ...
                            {notesExpanded && (
                                <div className="border-t border-slate-100 px-4 py-3">
                                    <TextArea
                                        ...
                                        error={form.errors.operational_notes}
                                        placeholder="Catatan akses, jam ramai, atau patokan lokasi"
                                    />
                                    {isEdit && (
                    ...
                    <div className="lg:col-span-2">
                        <Section
                            title="Lokasi Outlet"
                            subtitle="Cari alamat atau klik pada peta untuk menentukan lokasi outlet."
                        >
                            <Suspense
                                fallback={
