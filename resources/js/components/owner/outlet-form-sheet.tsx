                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-5">
                    ...
                    <div className="lg:col-span-2">
                        <Section title="Lokasi Outlet" subtitle="Cari alamat atau klik pada peta untuk menentukan lokasi outlet.">
                            <Suspense fallback={<div className="flex h-[300px] items-center justify-center rounded-lg border border-slate-300 bg-slate-50 text-xs font-semibold text-slate-500 lg:h-[400px]">Loading peta...</div>}>
