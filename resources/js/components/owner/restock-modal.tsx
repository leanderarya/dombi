                ...
                <div className="mt-3">
                    ...
                    <div className="relative mt-2">
                        <input
                            ...
                            min={1}
                            placeholder="Jumlah"
                            className="w-full rounded-lg border border-slate-200 bg-white py-2.5 pr-12 pl-4 text-sm font-bold tabular-nums focus:border-emerald-400 focus:ring-1 focus:ring-emerald-200"
                            autoFocus
                        />
