        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center lg:items-center" role="dialog" aria-modal="true">
            ...
            <div className="relative w-full max-w-md animate-[slideUp_200ms_ease-out] rounded-t-2xl bg-white pb-[env(safe-area-inset-bottom)] lg:animate-none lg:rounded-xl lg:pb-0 lg:shadow-xl">
                ...
                <form onSubmit={handleSubmit} className="px-6 pb-6 pt-2 lg:pt-6">
                    ...
                    <div className="mt-3">
                        <div className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Stok Saat Ini</div>
                        <div className="mt-1 text-sm font-semibold text-slate-700">{currentStock} pcs</div>
                    </div>

                    <div className="mt-3">
                        <label className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Tambah Stok</label>
                    ...
                    <div className="mt-3">
                        <label className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Catatan</label>
                        <textarea
                            value={notes}
