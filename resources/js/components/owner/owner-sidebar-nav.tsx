...
export default function OwnerSidebarNav({ navGroups, pendingCounts, collapsed = false }: Props) {
    const { url } = usePage();
    ...
    if (collapsed) {
        const activeFlyoutGroup = flyoutGroup ? navGroups.find((g) => g.label === flyoutGroup) : null;
        ...
        return (
            <>
                            ...
                            <div key={group.label} className="relative mt-0.5">
                                <button
                                    onClick={(e) => {
                                        ...
                                        setFlyoutGroup(isFlyoutOpen ? null : group.label);
                                    }}
                                    title={group.label}
                ...
                {activeFlyoutGroup && (
                    ...
                    >
                        <div className="px-3 py-1.5 text-[10px] font-semibold uppercase tracking-widest text-text-subtle">{activeFlyoutGroup.label}</div>
