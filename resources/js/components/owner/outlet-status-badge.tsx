const styles: Record<string, string> = {
    ...
    temporarily_closed: 'bg-amber-50 text-amber-700 ring-1 ring-inset ring-amber-600/10',
    maintenance: 'bg-orange-50 text-orange-700 ring-1 ring-inset ring-orange-600/10',
