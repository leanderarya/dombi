        ...
        <Dialog open={open} onOpenChange={(v) => !v && !busy && onClose()}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription id="reject-dialog-desc">
                        Order #{orderCode}
                    </DialogDescription>
                </DialogHeader>
                <form
                    ...
                    <div role="radiogroup" aria-label="Alasan Penolakan">
                        ...
                        <div className="mt-1 space-y-1">
                            {REASONS.map((r) => (
                                <label
                                    key={r.value}
                                    className="flex cursor-pointer items-center gap-2 rounded-lg border border-border p-2 text-xs has-[:checked]:border-primary has-[:checked]:bg-primary/5"
                                >
                                    <input
                                        type="radio"
                                        name="reason"
