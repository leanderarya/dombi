...
export default function PickupOutletSelector({
    items,
    initialRecommendations,
    selectedOutletId,
    onSelect,
    ...
    useEffect(() => {
        ...
        if (
            ...
            !alternatives.some((outlet) => outlet.id === selectedOutletId) &&
    ...
    const selectedOutlet = useMemo(
        () =>
            alternatives.find((outlet) => outlet.id === selectedOutletId) ??
    ...
    const hasRecommendations =
        recommendations.recommended && alternatives.length > 0;
    const otherOutlets = alternatives.filter(
        (o) => o.id !== recommendations.recommended?.id,
    );
                            ...
                            {selectedOutlet.distance_km !== null &&
                                selectedOutlet.distance_km !== undefined && (
                                    <div className="text-xs font-semibold text-text tabular-nums">
                                        {selectedOutlet.distance_km.toFixed(1)}{' '}
                                        km
                                    </div>
                                )}
                            <div
                                            ...
                                            <div className="ml-3 flex shrink-0 items-center gap-2">
                                                <div className="text-right">
                                                    {outlet.distance_km !==
                                                        ...
                                                        outlet.distance_km !==
                                                            undefined && (
                                                            <div className="text-[11px] font-medium text-text-muted tabular-nums">
