...
function ActionButton({ item }: { item: Action }) {
    const base = item.variant === 'secondary'
        ? 'inline-flex min-h-11 items-center justify-center rounded-lg border border-zinc-200 bg-white px-4 text-sm font-semibold text-slate-700 active:bg-zinc-50'
