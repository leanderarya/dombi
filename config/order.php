...
return [
    'confirmation_timeout_minutes' => (int) env('ORDER_CONFIRMATION_TIMEOUT_MINUTES', 30),
    ...
    'payment_retry_window_minutes' => (int) env('ORDER_PAYMENT_RETRY_WINDOW_MINUTES', 15),

    'doku_reconciliation_deadline_hours' => (int) env(
